    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">Manage your connections with others.</p>
        </div>
        ...
        <div className="mb-8 flex flex-wrap gap-6">
          {dataArray.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center gap-1 border h-20 w-40 border-gray-200
        ...
        <div className="inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-md">
          {dataArray.map((tab) => (
            <button
              ...
              key={tab.label}
              className={`cursor-pointer flex items-center px-3 py-1 text-sm rounded-md transition-colors ${currentTab === tab.label
            ...
            .value.map((user) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="flex max-sm:flex-col ga-2 mt-4">
                    {user.bio.slice(0, 30)}...
                  </p>
                  ...
                  <div className="flex gap-4 my-2">
                    {
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-pink-600 hover:from-indigo-600
