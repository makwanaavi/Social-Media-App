import { BadgeCentIcon, BadgeCheck, X } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-gray-700">
        <div
          className="h-full bg-white transition-all duration-500 linear"
      ...
      <button
        onClick={handleClose}
        className="absolute top-4 right-4 text-white font-bold focus:outline-none"
      >
